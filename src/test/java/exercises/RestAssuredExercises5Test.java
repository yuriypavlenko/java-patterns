...
public class RestAssuredExercises5Test {
    ...
    public void getAccountsForCustomer12212_deserializeIntoList_checkListSize_shouldEqual3() {
        ...
        given().
                spec(requestSpec).
        when().
                get("/customer/12212/accounts").as(AccountResponse.class);

        assertEquals(response.getAccounts().size(), 3);
    }
    ...
    public void postCustomerObject_checkReturnedFirstAndLastName_expectSuppliedValues() {
        ...
        Customer customerToSent = new Customer("John", "Smith");
        ...
        given().
                ...
                body(customerToSent).
        when().
                post("/customer").as(Customer.class);

        assertEquals(customerToSent.getFirstName(), customerReturned.getFirstName());
        assertEquals(customerToSent.getLastName(), customerReturned.getLastName());
    }
}