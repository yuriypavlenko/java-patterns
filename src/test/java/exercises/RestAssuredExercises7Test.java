    ...
    public void fromUserId_findPhotoTitle_expectPariaturSuntEveniet() {
         ...
         ******************************************************/
            ...
            when().
                    get("/users").
            then().
                    extract().path("find { it.username == 'Karianne' }.id");

        /*******************************************************
         * Use a JUnit assertEquals to verify that the userId
         * is equal to 4
         ******************************************************/
        assertEquals(4, id, "id");
         ...
         ******************************************************/
            ...
            when().
                    get("/albums").
            then().extract().path(String.format("findAll { it.userId == %d}.id", id));
         ...
         ******************************************************/
            ...
            given().
                spec(requestSpec).
            when()
                    .get(String.format("/albums/%d/photos", albums.get(4))).as(Photo[].class));
